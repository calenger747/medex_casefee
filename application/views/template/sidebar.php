<div class="sidebar" data-color="purple" data-background-color="black">
  <div class="logo">
    <a href="<?= base_url(); ?>Medex" class="simple-text logo-mini">
      D
    </a>
    <a href="<?= base_url(); ?>Medex" class="simple-text logo-normal">
      Dashboard
    </a>
  </div>
  <div class="sidebar-wrapper">
    ...
    <ul class="nav">
      ...
      <li class="nav-item <?php if($this->uri->segment(1) == 'Casefee' || $this->uri->segment(1) == 'casefee'){ echo "active"; } ?>">
        <a class="nav-link" href="<?= base_url(); ?>Casefee">
